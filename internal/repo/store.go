...
import (
	...
	"github.com/11DingKing/kunming-civic-bridge-20260821/internal/index"
	"github.com/11DingKing/kunming-civic-bridge-20260821/internal/shard"
...
func (s *Store) GetItem(ctx context.Context, id string) (*domain.Suggestion, error) {
	return s.index.GetItemByID(ctx, id)
}

func (s *Store) GetItemByExternalRef(ctx context.Context, ref string) (*domain.Suggestion, error) {
	return s.index.GetItemByExternalRef(ctx, ref)
}

func (s *Store) ListItems(ctx context.Context, filter domain.ItemFilter) ([]*domain.Suggestion, int, error) {
	return s.index.ListItems(ctx, filter)
}

func (s *Store) FindOverdueItems(ctx context.Context, now time.Time, maxLevel int) ([]*domain.Suggestion, error) {
...
func (t *storeTx) SaveItem(ctx context.Context, item *domain.Suggestion) error {
