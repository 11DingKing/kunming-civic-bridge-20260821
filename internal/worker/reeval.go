...
func (w *ReevalWorker) collectStaleItems(ctx context.Context, currentVersion int) ([]*domain.Suggestion, error) {
	var stale []*domain.Suggestion
...
func (w *ReevalWorker) reevaluateItem(ctx context.Context, item *domain.Suggestion, rules []*domain.Rule, currentVersion int) error {
