...
type ItemDetail struct {
	Suggestion  *domain.Suggestion   `json:"item"`
...
type BacklogStats struct {
	...
	OverdueItems []*domain.Suggestion      `json:"overdue_items"`
}
...
func (s *QueryService) ListItems(ctx context.Context, filter domain.ItemFilter) ([]*domain.Suggestion, int, error) {
	return s.store.ListItems(ctx, filter)
}

func (s *QueryService) GetItem(ctx context.Context, id string) (*domain.Suggestion, error) {
